    ...
    <div className="flex items-center gap-4">
      ...
      <div className="flex items-center gap-3">
        <Link
          ...
          className={`
            rounded-full bg-gradient-to-r from-pink-500 to-rose-500 p-2
        ...
        <Link
          aria-label="WhatsApp"
          className={`
            rounded-full bg-green-500 p-2 text-white transition-transform
            hover:scale-110
          `}
        ...
        <Link
          aria-label="Email"
          className={`
            rounded-full bg-orange-500 p-2 text-white transition-transform
            hover:scale-110
          `}
          href="mailto:info@chocolatedrop.com"
        >
          <svg
            aria-hidden="true"
            className="h-4 w-4"
